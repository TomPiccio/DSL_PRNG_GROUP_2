...
HD_PWD='C:/Users/Administrator.LAPTOP-S0NU6TDL/OneDrive - Singapore University of Technology and Design/10. Term 6/Digital Systems Lab/seedGen/seedGen.runs/impl_1'
cd "$HD_PWD"
